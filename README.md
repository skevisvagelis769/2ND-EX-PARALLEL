...
(Η επεξήγηση του MPI_MAXLOC πάρθηκε απο εδώ (λόγω τρόπου επεξήγησης) https://rookiehpc.org/mpi/docs/mpi_maxloc/index.html)
...
Για κάθε ερώτημα (Ι .. ΙV) παρέχονται .txt αρχεία με δοκιμαστικές τιμές για εκτέλεση.

Οι πρώτες 2 τιμές είναι με τη σειρά:
